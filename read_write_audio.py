...
# Read sound data
def read_audio(filePath, sr=22050, n_fft=2048, win_length=2048, hop_length=512, flag_to_draw=False):
    """
    Parameters
    ...
    ### START
    ### The code here is to extract voice from raw file
    ### END

    y, sr = lr.load(filePath, sr) # Loading Data
